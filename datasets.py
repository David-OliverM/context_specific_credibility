...
def get_dataloader(cfg):
    ...
    return DATASET_DICT[dname](data_dir, batch_size=cfg.batch_size, noise_severity=cfg.noise_severity, exp_setup = cfg.exp_setup, test_noise = cfg.test_noise, **cfg.experiment.dataset.args)
